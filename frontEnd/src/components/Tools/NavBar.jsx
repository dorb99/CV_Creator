          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <Link
                  to="/"
                  className="py-2 hover:bg-blue-950 p-4 text-2xl flex hover:text-white text-gray-400 transition-all ease-in-out"
                >
                ...
                {userInfo ? (
                  <button
                    className="bg-yellow-600 hover:bg-yellow-700 py-2 px-6 rounded-lg text-yellow-100 border-b-4 border-yellow-700 hover:border-yellow-800 transition duration-300 focus:outline-none focus:border-yellow-800 hover:border-none tracking-widest mt-4"
